...
productDTO = new ProductDTO(product);
    ...
    @Test
    public void insertShouldReturnUnprocessableEntityWhenAdminLoggedAndPrinceIsNegative() throws Exception {
    ...
    @Test
    public void insertShouldReturnUnprocessableEntityWhenAdminLoggedAndPrinceIsZero() throws Exception {
    ...
    @Test
    public void insertShouldReturnForbiddeWhenClientLogged() throws Exception {
